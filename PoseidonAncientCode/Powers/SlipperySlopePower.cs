...
public class SlipperySlopePower : PoseidonAncientTemporaryPower
{
    ...
    protected override IHoverTip InternallyAppliedPowerHoverTip => HoverTipFactory.FromPower<StrengthPower>();
