...
public class HighSurfPower : PoseidonAncientTemporaryPower
{
    ...
    protected override IHoverTip InternallyAppliedPowerHoverTip => HoverTipFactory.FromPower<DexterityPower>();
